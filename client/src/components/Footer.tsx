...
export const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-gradient-to-br from-gray-50 to-blue-50/30 dark:from-gray-900 dark:to-gray-800 border-t border-gray-100 dark:border-gray-800">
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <img src="/2025-07-14 1.05.36 PM.jpg" alt="Millat Umidi Group" className="h-12 w-12 object-contain rounded-full" />
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Millat Umidi Group</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">Building Tomorrow's Education</p>
              </div>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Transforming education across Uzbekistan with innovative technology and passionate leadership.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <a href="/" className="block text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 transition-colors">
                Home
              </a>
              <a href="/gallery" className="block text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 transition-colors">
                Gallery
              </a>
              <a href="#contact" className="block text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 transition-colors">
                Contact
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-12 pt-8 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Millat Umidi Group. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
