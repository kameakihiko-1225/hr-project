...
export const FeaturesSection = () => {
  ...
  const features = [
    {
      icon: Target,
      titleKey: "career_growth",
      descriptionKey: "career_growth_desc",
    ...
    {
      icon: Ban,
      titleKey: "work_life_balance",
      descriptionKey: "work_life_balance_desc",
      color: "from-purple-500 to-purple-600"
    },
    {
      icon: Cpu,
      titleKey: "competitive_benefits",
      descriptionKey: "competitive_benefits_desc",
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="text-center mt-12">
          ...
          >
            ...
            <span className="hidden sm:inline">{t('founder.cta')}</span>
