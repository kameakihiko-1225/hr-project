          ...
          <div className="founder-content-container order-1 lg:order-2">
            ...
            <div className="grid grid-cols-2 gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">{t('founder.experience_years')}</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">1000+</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">{t('founder.students_impacted')}</div>
              </div>
            </div>
          </div>
        </div>
